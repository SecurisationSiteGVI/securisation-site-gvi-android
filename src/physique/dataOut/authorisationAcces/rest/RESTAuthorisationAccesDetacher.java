 ...
 * @author damien
 */
public class RESTAuthorisationAccesDetacher {
    public static void execute(Ressource ressource, Secteur secteur, Utilisateur utilisateur) throws MalformedURLException, IOException {
        URL url = new URL(ressource.getPathToAccesWebService() + "authorisationacces/detacher/"+utilisateur.getId()+"/"+secteur.getId());
