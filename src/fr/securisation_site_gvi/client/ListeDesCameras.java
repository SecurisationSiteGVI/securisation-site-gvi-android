 ...
 * @author damien
 */
public class ListeDesCameras extends TemplateActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ListeDesCameras.RESTCameraCount().execute();
    }
    ...
    private void remplirListView() {
        ...
        new ListeDesCameras.RESTCameraGetAllByRAnge().execute();
    }
    ...
    public void addActionListnerForAllGraphicalObjects() {
        this.list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                builder.setMessage("Voulez-vous supprimer la caméra :" + u.get(pos).toString() + " ?");
                builder.setPositiveButton("Oui", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Camera camera = u.get(pos);
                        dialog.cancel();
                        new ListeDesCameras.RESTCameraRemove().execute(camera);
    ...
    private class RESTCameraGetAllByRAnge extends AsyncTask<Object, Void, Object> {
        ...
        protected void onPostExecute(Object result) {
            ...
            if (!erreur) {
                List<Camera> positions = (List<Camera>) result;
                u = positions;
        ...
        protected Object doInBackground(Object... params) {
            Object ret = null;
            try {
                ret = this.cameraSrv.getAll(activityContext, index, nbLinge);
    ...
    private class RESTCameraCount extends AsyncTask<Object, Void, Object> {
        ...
        protected Object doInBackground(Object... params) {
            Object ret = null;
            try {
                ret = this.cameraSrv.count(activityContext);
            } catch (MalformedURLException ex) {
                erreur = true;
                ret = new MalformedURLException();
    ...
    private class RESTCameraRemove extends AsyncTask<Object, Void, Object> {
        ...
        protected void onPreExecute() {
            //super.onPreExecute();
            this.progressDialog = ProgressDialog.show(activityContext, "", "Suppression de la caméra...", true);
        }
        ...
        protected void onPostExecute(Object result) {
         this.progressDialog.cancel();
            if (!erreur) {remplirListView();
                    Toast.makeText(activityContext, "Caméra bien supprimé.", Toast.LENGTH_LONG).show();
            } else if (result instanceof MalformedURLException) {
                throwMalformedURLException();
            } else if (result instanceof IOException) {
                throwIOException();
        ...
        protected Object doInBackground(Object... params) {
            Object ret = null;
            try {
                cameraSrv.remove(activityContext, (Camera) params[0]);
            } catch (MalformedURLException ex) {
                erreur = true;
                ret = new MalformedURLException();
                Logger.getLogger(ListeBadges.class.getName()).log(Level.SEVERE, null, ex);
