 ...
 * @author damien
 */
public class AjoutBorneAcces extends TemplateActivity {
...
private int index;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ajouter_borneacces);
    ...
    public void initGraphicalObjects() {
        ...
        this.toggleButtonEntre = (ToggleButton) findViewById(R.id.AjoutBorneAccesToggleButtonEntre);
        this.buttonCree = (Button) findViewById(R.id.AjoutBorneAccesbuttonCree);
            ...
            public void onClick(View v) {
                if(positionSelected!=null){
                    ...
                    borneAcces.setNom(editTextNom.getText().toString());
                     ...
                     new AjoutBorneAcces.RESTCameraAjout().execute(borneAcces);
                }else{
