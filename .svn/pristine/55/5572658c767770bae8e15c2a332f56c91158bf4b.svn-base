 ...
 * @author damien
 */
public class RESTAuthorisationAccesUpdate {
    public static void execute(Ressource ressource, AuthorisationAcces authorisationAcces) throws MalformedURLException, IOException  {
        ...
        URL url = new URL(ressource.getPathToAccesWebService() + "authorisationacces/3/"+authorisationAcces.getHeureOuverture().getHours()+"/"+authorisationAcces.getHeureOuverture().getMinutes()+"/"+authorisationAcces.getHeureFermeture().getHours()+"/"+authorisationAcces.getHeureFermeture().getMinutes()+"/"+authorisationAcces.getUtilisateur().getId());
...
//                + "\"id\":\""+authorisationAcces.getUtilisateur().getId()+"\",\"nom"
